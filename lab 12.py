...
def zad_3():
    ...
    class IceCreamStandGUI:
        def __init__(self, main):
            ...
            self.flavors_label = tk.Label(main, text='Flavors', font='Georgia 12 bold')
            self.flavors_listbox = tk.Listbox(main, font='Georgia 12', height=len(self.ice_cream_stand.get_flavors()))

            for flavor in self.ice_cream_stand.get_flavors():
                self.flavors_listbox.insert(tk.END, flavor)

            self.prices_label = tk.Label(main, text='Prices', font='Georgia 12 bold')
            self.prices_listbox = tk.Listbox(main, font='Georgia 12', height=len(self.ice_cream_stand.get_prices()))
